...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    highlights: [
      { title: "全方位體質調理", detail: "結合多種科學實證成分，從根源調整生理機能，為忙碌的生活提供穩定的營養後盾。" },
      { title: "優質能量補給", detail: "添加天然酵母來源維生素 B 群，有效提振精神，幫助您面對高挑戰性的應酬場合，依然展現優雅戰力。" },
      { title: "高規格吸收技術", detail: "運用專利黑胡椒萃取技術，提升營養成分的吸收率，確保每顆膠囊的珍貴配方都能被身體充分利用。" },
      { title: "植萃抗氧化防護", detail: "富含薑黃、芝麻素與米糠萃取物，長期補給有助於維護循環健康，建立由內而外的抗氧化保護屏障。" },
    ],
    usage: ["繁忙的商務應酬人士，維持體態與社交靈活度", "長期熬夜、工作高壓的職場工作者", "重視日常養生、關注肝臟保健者", "建議應酬前或日常保養時適量食用"],
    disclaimer: "本產品為營養補充品，非藥品，不具醫療效能。請配合均衡飲食與良好作息，飲酒請勿過量。",
  },
  {
    slug: "growth-calcium",
    name: "MAL 成長鈣咀嚼錠",
